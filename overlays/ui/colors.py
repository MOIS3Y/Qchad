...
The module contains 35 popular color schemes.
They do not always correspond to the author's original, but I left
in each color scheme a link to the original.

I compiled these color schemes into the base16_colorlib library
Here the colors are duplicated so as not to pull the external dependence
if someone wants to copy the config or parts of it.
"""
color_schemes = {
    'aquarium' : {
        'scheme': 'aquarium',
