...
# https://github.com/jluttine/rofi-power-menu/blob/master/README.md
...
declare -A actions
actions[lockscreen]="loginctl lock-session self  #${XDG_SESSION_ID-}"
#actions[switchuser]="???"
actions[logout]="loginctl terminate-session self  #${XDG_SESSION_ID-}"
